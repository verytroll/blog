    ...
    return(
        <div className="sidebar">
            <div className="sidebarItem">
                ...
                <img src="/assets/about_me.webp" alt="" className="sidebarImage" />
            ...
            <div className="sidebarItem">
                ...
                <ul className="sidebarList">
                    {categories.map((category) => {
                        return (
                            <Link key={category._id} className="link" to={`/?cat=${category.name}`}>
                                <li className="sidebarListItem">{category.name[0].toUpperCase() + category.name.slice(1)}</li>
                            </Link>
                        );
                    })}
                </ul>
            ...
            <div className="sidebarItem">
                ...
                <div className="sidebarSocial">
                    <svg className="sidebarIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
